  ...
  return (
    <section id="equipo" className="px-4 md:px-10 py-8 md:py-10 bg-gradient-to-b from-white to-brand-mist/20">
      <div className="mb-5 md:mb-6">
        ...
        <h2 className="font-sans font-bold text-brand-navy text-2xl md:text-3xl">Nuestro equipo</h2>
      </div>
      <div className="biz-stagger grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {staff.map((m) => (
